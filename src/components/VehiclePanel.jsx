...
const VehiclePanel = ({ setVehiclePanelOpen, setConfirmRidePanelOpen, fare, setVehicleType, isFareLoading }) => {
    return (
        <div>
            <span onClick={() => {
            ...
            {isFareLoading ? <div className='w-full h-full flex justify-center items-center text-2xl min-h-40'>Looking For Rides...</div> :
                <div>
